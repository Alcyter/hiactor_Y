...
hiactor::DataType map_project_node(const hiactor::DataType& input,  std::vector<int> ID_site, std::vector<int> label_index, std::vector<std::vector<std::string>> propertyname, std::vector<int> reserve_site, hiactor::InternalValue& node, std::vector<hiactor::InternalValue>& ori_path);
