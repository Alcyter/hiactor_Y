...
public:
    ExecutorHandler() {
        std::string filename = "/home/yaojx/hiactor/demos/LDBC_Muti/actor/node.txt";
        _df.fromFile(filename);
    }
    // ExecutorHandler(int index) {
    //     std::string filename = "/home/yaojx/hiactor/demos/LDBC_Muti/actor/"+std::to_string(index)+"_node.txt";
    //     _df.fromFile(filename);
    // }
