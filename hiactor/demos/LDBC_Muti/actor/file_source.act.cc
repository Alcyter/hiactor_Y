...
FileSourceActor_Ref::FileSourceActor_Ref(): ::hiactor::reference_base() 
{
    // std::cout<<"FileSourceActor_Ref\n";
    actor_type = hiactor::TYPE_FILESOURCE; 
}
...
void FileSourceActor::process(hiactor::DataType&& input) {
    ...
    std::string filename = input._data.stringValue;
